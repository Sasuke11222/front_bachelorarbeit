...
//Seite für Generierung der USB-Sperrstatus
export default class USBListe extends Component {
    constructor(props) {
        super(props);
    ...
    deleteStatus(status_usb_id) {
        USBDataService.delete(status_usb_id)
            .then(response => {
    ...
    updateStatus = () => {
        fetch(`http://localhost:8080/api/status_usb/${this.state.aktuellerStatus.status_usb_id}`, {
            method: 'PUT',
            headers: {
                ...
                <Container style={container}>
                        <>
                            <div className="col-md-8">
                                <h3 style={h3}>USB-Sperrstatus: </h3>
                            </div>
                            <Row>
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                ...
                                                <Button variant="danger" style={button}
                                                        onClick={() => this.deleteStatus(aktuellerStatus.status_usb_id, currentIndex)}
                                                >
                                                    <FaTrashAlt/>
                                                </Button>
                                            </div>
