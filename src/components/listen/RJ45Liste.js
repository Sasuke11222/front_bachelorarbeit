...
//Seite für Generierung der RJ45-Sperrstatus
export default class RJ45Liste extends Component {
    constructor(props) {
        super(props);
    ...
    deleteStatus(status_rj45_id) {
        RJ45DataService.delete(status_rj45_id)
            .then(response => {
    ...
    updateStatus = () => {
        fetch(`http://localhost:8080/api/status_rj45/${this.state.aktuellerStatus.status_rj45_id}`, {
            method: 'PUT',
            headers: {
                ...
                <Container style={container}>
                        <>
                            <div className="col-md-8">
                                <h3 style={h3}>RJ45-Sperrstatus: </h3>
                            </div>
                            <Row>
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                ...
                                                <Button style={button} variant="danger"
                                                        onClick={() => this.deleteStatus(aktuellerStatus.status_rj45_id, currentIndex)}
                                                >
                                                    <FaTrashAlt/>
                                                </Button>
                                            </div>
